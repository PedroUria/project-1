...
Tenure should probably have a high standard deviation because our data only contains the records of customers who haven't churned, which we beleive explains the right skewed-ness we see represented by the `describe` output. 
